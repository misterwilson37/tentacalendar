...
**Document version: 0.7.0** | Last updated: 2026-07-10 | Last session: PRIORITY ENGINE v2 (app 0.6.0) — Katie's real-workflow sort replaces tier-first ordering
...
**Files: app.js 0.6.0 · store.js 0.6.0 · queue.js 0.5.0 · index.html 0.5.0 · tentacalendar.css 0.5.0 · config.js 0.4.0 (REAL Firebase values baked in — safe: web config is an identifier, not a secret; deploy wholesale, never revert to placeholders) · celebrate.js 0.1.1 · firestore.rules 0.1.0 · SETUP.md 0.2.1.**
