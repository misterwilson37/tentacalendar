...
**Document version: 0.8.0** | Last updated: 2026-07-10 | Last session: Phase 1 exit-checklist feedback shipped — decision modal v2, collapsible cards, un-complete rewind, duplicate-for-next-year, per-tier allowed days, settings tabs (D51–D60)
...
**Files: app.js 0.7.0 · store.js 0.7.0 · queue.js 0.7.0 · index.html 0.6.0 · css 0.6.0 · config.js 0.4.0 (REAL Firebase values baked in — safe: web config is an identifier, not a secret; deploy wholesale, never revert to placeholders) · celebrate.js 0.1.1 · firestore.rules 0.1.0 · SETUP.md 0.2.1.** Import ?v= strings (D49): app.js ← index.html @0.7.0; css ← index.html @0.6.0; config @0.4.0 + store @0.7.0 + queue @0.7.0 + celebrate @0.1.1 ← app.js; config @0.4.0 ← store.js.
...
**Smoke tests for v0.7.0 (this release):**
